...
export class ProjectsComponent {
  ...
  projects: Project[] = [
    ...
    },
    {
      ...
      featured: false,
      summary:
        'PWA & native Android-App zur Reiseplanung mit Countdown, Packliste, interaktiver Karte und lokaler Datenspeicherung – ohne Backend.',
      description:
        'Persönlicher Reise-Assistent mit Countdown, Packliste, Flugverwaltung, interaktiver Karte und POI-Suche. Läuft als installierbare PWA im Browser und als native Android-App – alle Daten bleiben lokal auf dem Gerät.',
      technicalDescription:
        'Umgesetzt als Vanilla-JavaScript-Anwendung mit ES Modules ohne Framework. Die App ist als PWA installierbar (manifest.json + Service Worker für Offline-Cache) und läuft auf Android via WebView mit Kotlin-Bridge. Kartenintegration erfolgt über Leaflet.js mit OpenStreetMap, POI-Suche über die Overpass API in 9 Kategorien mit einstellbarem Suchradius. Reisedaten und Packliste werden in localStorage gespeichert, Dokumente (PDF, Bilder) in IndexedDB. Die Kotlin-Seite stellt eine JS-Bridge bereit, um native Funktionen wie das Öffnen von Dateien und URLs im Systembrowser zu nutzen.',
      impact: 'Offline-fähige PWA, lokale Datenpersistenz, GPS-basierte POI-Suche, native Android-Integration',
      role: 'Konzeption, Architektur, Frontend-Entwicklung und Android-Integration',
      focus: 'Vanilla JS, PWA, Leaflet, Overpass API, IndexedDB, Kotlin WebView',
      technologies: ['JavaScript', 'HTML5', 'CSS', 'PWA', 'Leaflet.js', 'Kotlin', 'Android'],
  ...
  readonly techIconMap: Record<string, string> = {
    ...
    'PWA': 'devicon-chrome-plain colored',
